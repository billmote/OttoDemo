 ...
 * chance to handle dead events, they are wrapped in an instance of {@link com.squareup.com.squareup.otto.DeadEvent} and
 * reposted.
 * 
 * <p>
...
public class Bus {
    ...
    public void register(Object object) {
        ...
        Log.w(TAG, String.format("register: %s", String.valueOf(object.hashCode())));
    ...
    public void unregister(Object object) {
        enforcer.enforce(this);
        Log.w(TAG, String.format("unregister: %s", String.valueOf(object.hashCode())));
